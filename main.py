...
parser.add_argument(
    "--drop_out", action="store_true", default=False, help="enable dropout (p=0.25)"
)
parser.add_argument(
    "--bag_loss",
    type=str,
...
if args.task == "task_1_tumor_vs_normal":
    ...
    dataset = Generic_MIL_Dataset(
        csv_path="/gpfs/mskmind_ess/kohlia/BR_16-512/codebase/updated/breast-ana/breastana/path_tr_data.csv",
        # data_dir = os.path.join(args.data_root_dir, 'tumor_vs_normal_resnet_features'),
        data_dir="/gpfs/mskmind_emc/data_user/kohlia/BR_16-512/BR_16-512_embeddings/512",
        shuffle=False,
        seed=args.seed,
        print_info=True,
        label_dict={0: 0, 1: 1},
