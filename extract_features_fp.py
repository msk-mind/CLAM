...
def compute_w_loader(
        file_path, output_path, wsi, model, src_filesystem, dst_filesystem,
        batch_size = 8, verbose = 0, print_every=20, pretrained=True, 
        custom_downsample=1, target_patch_size=-1, slide_file_path=None, storage_options=None):
    """
    args:
    ...
    dataset = Whole_Slide_Bag_FP(file_path=file_path, wsi=wsi, pretrained=pretrained, 
        ...
        filesystem=src_filesystem, slide_file_path=slide_file_path, storage_options=storage_options)
    ...
    for count, (batch, coords) in enumerate(loader):
        with torch.no_grad():   
            ...
            with dst_filesystem.open(str(Path(output_path)), "ab+") as output_f:
...
if __name__ == '__main__':
    ...
    src_filesystem, src_path = fsspec.core.url_to_fs("simplecache::" + args.data_h5_dir, s3=storage_options)
    dst_filesystem, dst_path = fsspec.core.url_to_fs("simplecache::" + args.feat_dir, s3=storage_options)
