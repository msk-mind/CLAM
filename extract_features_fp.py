...
sys.path.append('/gpfs/mskmind_ess/mindeng/path_txformer_example/TransPath')
...
if __name__ == '__main__':
	...
	if args.model == 'resnet50':
		...
		model = torch.load('/gpfs/mskmind_ess/mindeng/path_txformer_example/TransPath/CTransPath_Model.pt')
		USE_IMAGENET_RGB_DIST = True
