...
#         self.name = ".".join(path.split("/")[-1].split('.')[:-1])
    ...
    def segmentTissue(self, seg_level=0, sthresh=20, sthresh_up = 255, mthresh=7, close = 0, use_otsu=False,
                            filter_config={'a_t':100}, ref_patch_size=512, exclude_ids=[], keep_ids=[]):
        """
        ...
        if filter_config: foreground_contours, hole_contours = _filter_contours(contours, hierarchy, filter_config)  # Necessary for filtering out artifacts
